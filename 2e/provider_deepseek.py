from models import Message, AssistantMessage, ToolCall, ToolDefinition
import json
...
def to_deepseek_tool_definitions(tools: list[ToolDefinition]) -> list[dict]:
    return [to_deepseek_tool_definition(tool) for tool in tools]
